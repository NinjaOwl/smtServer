...
<div class="user-form">
    ...
    <div class="form-group user-nation-factory_id">
        <label class="control-label" for="user-factory_id">工厂</label>
        <?php
        ...
        echo AutoComplete::widget([
            ...
            'clientOptions' => [
                ...
                $('#user-factory_id').val(ui.item.id);
            }"),
    ...
    <?= Html::activeHiddenInput($model, 'factory_id') ?>
